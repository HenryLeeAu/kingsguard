...
import { preferStateOverComputedStyle } from '../src/rules/prefer-state-over-computed-style.js';
...
const ruleId = '@kingsguard/sentinel/react-prefer-state-over-computed-style';
